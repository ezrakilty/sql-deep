module TranslateRW where

--
-- Small-step version of compilation: local rewrite rules applied willy-nilly.
--
...
--     | lorob t   = Nothing
--     | otherwise = 
--         Empty (Comp "x" m (Singleton (Unit, TUnit), TList Tunit), TList TUnit)
rw (DB m, t) = Just m
rw _ = Nothing
